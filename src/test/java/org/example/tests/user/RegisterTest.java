...
import org.example.api.BaseSteps;
import org.example.data.User;
import org.example.pages.HomePage;
import org.example.steps.ActionsUser;
...
public class RegisterTest {
    ...
    public void createUser1() {
        ...
        int id = (int) BaseSteps.getValue(response, "user.id");
        String token = (String) BaseSteps.getValue(response, "access_token.access_token");
        Response response2 = actionsUser.loginUser(user);
        String token2 = (String) BaseSteps.getValue(response2, "token.access_token");
    ...
    @Test
    @DisplayName("Registration exist user")
    @Description("Registration exist user")
    ...
    public void createUserWithoutRepeatPassword() throws InterruptedException {
        ...
        homePage.clickCreateAccountButton();
        homePage.checkPasswordsDontMatch();
    }
